...
async function readyRun(args){
  ...
  if(!strcmp(args.output_format, 'c_array')) {
    ...
    switch(args.cf) {
      ...
      case 'alpha_1':
      case 'alpha_1_bit':
        conv.convert('alpha_1_bit', 1, downc);
        break;
      case 'alpha_2':
      case 'alpha_2_bit':
        conv.convert('alpha_2_bit', 1, downc);
        break;
      case 'alpha_4':
      case 'alpha_4_bit':
        conv.convert('alpha_4_bit', 1, downc);
        break;
      case 'alpha_8':
      case 'alpha_8_bit':
        conv.convert('alpha_8_bit', 1, downc);
        break;
      case 'indexed_1':
      case 'indexed_1_bit':
        conv.convert('indexed_1_bit', 0, downc);
        break;
      case 'indexed_2':
      case 'indexed_2_bit':
        conv.convert('indexed_2_bit', 0, downc);
        break;
      case 'indexed_4':
      case 'indexed_4_bit':
        conv.convert('indexed_4_bit', 0, downc);
        break;
      case 'indexed_8':
      case 'indexed_8_bit':
        conv.convert('indexed_8_bit', 0, downc);
        break;
      case 'raw':
        conv.convert('raw', 0, downc);
        break;
      case 'raw_alpha':
        conv.convert('raw_alpha', 1, downc);
        break;
      case 'raw_chroma':
        conv.convert('raw_chroma', 0, downc);
        break;
      default:
        break;
    }
